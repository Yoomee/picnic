module TramlinesContentFilter::SemanticFormBuilderExtensions
  ...
  def inline_errors_for_with_content_filter(method, options = nil)
    if @object.nil? || !@object.respond_to?(:errors) || !@object.errors.empty? || !@object.respond_to?(:content_filter_errors)
  ...
  def input_with_content_filter(method, options = {})
    if @object && @object.respond_to?(:errors) && @object.errors.blank? && @object.respond_to?(:content_filter_errors) && !@object.content_filter_errors.blank?
      ret = ""
