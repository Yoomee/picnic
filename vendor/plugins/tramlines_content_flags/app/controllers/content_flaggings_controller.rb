class ContentFlaggingsController < ApplicationController
  ...
  def create
    @content_flagging = ContentFlagging.new(params[:content_flagging].merge(:member => @logged_in_member, :ip_address => request.remote_ip))
