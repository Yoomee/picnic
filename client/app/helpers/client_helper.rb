module ClientHelper
  ...
  def viewing_club?
    current_page?(club_path) || current_page?(new_member_path) || current_page?(connections_path) || current_page?(leaderboard_path) || current_page?(:controller => "members", :action => "show") || controller_name=="tags"
  end
