class Member < ActiveRecord::Base
  ...
  YOOMEE_EMAILS = %w{andy@yoomee.com nicola@yoomee.com si@yoomee.com rich@yoomee.com ian@yoomee.com rob@yoomee.com matt@yoomee.com support@yoomee.com edward@yoomee.com}
  ...
  has_many :photo_albums, :as => :attachable
  ...
  after_destroy :destroy_non_system_photos_albums
  ...
  private
  def destroy_non_system_photos_albums
    photo_albums.non_system.destroy_all
  end
